...
const AddConvo = () => {
    ...
    return (
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mt-4">
                ...
                <h2 className='text-xl font-normal mt-2 mb-5'>Add A Questionnaire/Survey</h2>

                <form onSubmit={handleSubmit}>

                    <CustomForm formFields={formFileds} onChange={handleChange} onSubmit={handleSubmit} formData={formData} />

                    <Button type='submit' className='bg-green-200 py-2 px-6 text-lg rounded-lg hover:bg-green-500'>Save Questionnaire</Button>
